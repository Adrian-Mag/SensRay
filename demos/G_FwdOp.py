...
class G:
    ...
    def __calcMatrix__(self):
        ...
        for (source_lat, source_lon, source_depth), (receiver_lat, receiver_lon), phases in self.__srp:
            self.__computeKernels__(source_lat, source_lon, source_depth, receiver_lat, receiver_lon, phases)
    ...
    def __computeKernels__(self, source_lat, source_lon, source_depth, receiver_lat, receiver_lon, phases):
