...
- PlanetMesh: generate tetrahedral meshes from a PlanetModel, map properties onto mesh cells, compute per-cell ray lengths and sensitivity kernels, and visualize slices.
...
- PlanetMesh supports tetrahedral mesh generation. Tetrahedral generation requires `pygmsh` + `meshio`.
